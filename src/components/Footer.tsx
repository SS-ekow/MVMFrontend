                ...
                <div className="bg-blue-800 text-sm text-white p-8">
                    <a href="/">
                            <div className="flex items-center">
                              <div className='w-10 h-10 rounded-full bg-white text-blue-800 text-xl text-center font-extrabold flex items-center justify-center'><PiDevicesDuotone /></div>
                    ...
                    <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="#" className="hover:underline">About teckZone</a></li>
                                <li><a href="#" className="hover:underline">Investor Relations</a></li>
                                <li><a href="#" className="hover:underline">teckZone Devices</a></li>
                                <li><a href="#" className="hover:underline">teckZone Science</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-white font-bold mb-2">Make Money with Us</h3>
                            <ul>
                                <li><a href="#" className="hover:underline">Sell products on teckZone</a></li>
                                <li><a href="#" className="hover:underline">Sell on teckZone Business</a></li>
                        ...
                        <div>
                            ...
                            <ul>
                                <li><a href="#" className="hover:underline">teckZone Business Card</a></li>
                                <li><a href="#" className="hover:underline">Shop with Points</a></li>
                                <li><a href="#" className="hover:underline">Reload Your Balance</a></li>
                                <li><a href="#" className="hover:underline">teckZone Currency Converter</a></li>
                            </ul>
                        </div>
                        <div>
